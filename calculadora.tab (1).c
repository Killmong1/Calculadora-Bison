...
{
  "\"end of file\"", "error", "\"invalid token\"", "UMINUS", "NUMBER",
  "ADD", "SUB", "MUL", "DIV", "ABS", "LPAREN", "RPAREN", "EOL", "POW",
  "SQRT", "MOD", "$accept", "calclist", "exp", "term", "factor", YY_NULLPTR
};
...
{
      -1,   -12,    -1,    -1,    28,     1,    19,    15,   -11,   -12,
      23,   -12,    -1,   -12,    21,    -1,    -1,   -12,    -1,    -1,
      -1,    -1,   -12,    30,   -12,    15,    15,   -11,   -11,   -11,
     -12,   -12
};
...
{
       0,    11,     0,     0,     0,     0,     0,     6,    10,    12,
       0,    16,     0,     1,     0,     0,     0,     2,     0,     0,
       0,     0,    13,     0,     3,     4,     5,     7,     8,     9,
      14,    15
};
...
{
       9,    13,    21,     1,     0,     1,    25,    26,     2,     3,
       2,     3,    10,     4,    14,     4,    27,    28,    29,    30,
       0,    23,    18,    19,    15,    16,    15,    16,    15,    16,
      20,    17,    11,    24,    22,    15,    16,     0,    12,     0,
       0,    31
};

static const yytype_int8 yycheck[] =
{
       2,     0,    13,     4,    -1,     4,    15,    16,     9,    10,
       9,    10,     3,    14,     5,    14,    18,    19,    20,    21,
      -1,    12,     7,     8,     5,     6,     5,     6,     5,     6,
      15,    12,     4,    12,    11,     5,     6,    -1,    10,    -1,
      -1,    11
};
...
{
       0,     4,     9,    10,    14,    17,    18,    19,    20,    20,
      18,     4,    10,     0,    18,     5,     6,    12,     7,     8,
      15,    13,    11,    18,    12,    19,    19,    20,    20,    20,
      20,    11
};
...
#line 55 "calculadora.y"
        ...
        if (yyvsp[0] == 0) {
            ...
            yyval = 0;  // Valor por defecto para indicar error
